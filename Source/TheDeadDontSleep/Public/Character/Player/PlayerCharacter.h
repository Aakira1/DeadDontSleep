...
public:
    ...
    #pragma region GAS Public Functions
...
#pragma endregion Player Movement
    ...
    // =========================== Functions ===================================================
    #pragma region Tick, Input, Begin //public functions
    // Called every frame
...
protected:
    // ============================ Properties & Variables ====================================
    #pragma region GAS Ability system //protected 
    ...
    // =========================== Functions ===================================================
    #pragma region Tick, Input, Begin //Protected functions
