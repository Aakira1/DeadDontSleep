...
#include "World/Interaction/InterfaceTestActor.h"
...
{
    UE_LOG(LogTemp, Warning, TEXT("Calling Begin Interact"));
}

void AInterfaceTestActor::EndInteract()
{
    UE_LOG(LogTemp, Warning, TEXT("Calling End Interact"));
}

void AInterfaceTestActor::Interact()
{
    UE_LOG(LogTemp, Warning, TEXT("Calling Interact Interact"));
}
